...
public class Nature : MonoBehaviour {
    ...
    void ResetCar()
    {
        Car.transform.position = new Vector3(1376.09f, 9.156602f, -410.07f);
        ...
        Car.gameObject.GetComponent<CustomCarController>().lastLoc = new Vector3(1376.09f, 9.156602f, -410.07f);
    }
